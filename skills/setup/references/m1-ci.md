...
Templates: `templates/m1-ci/`. Reference implementation: `ANSUT-DSIS/sitewebgrandechancellerie` `.github/workflows/ci.yml` (the full version with every website-specific gate — useful when a project wants to graduate into the optional extensions below).
