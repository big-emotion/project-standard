...
Full rationale and decisions: [SPEC.md](SPEC.md). Reference implementations: `ANSUT-DSIS/sitewebgrandechancellerie` (M1–M3), `big-emotion/support-agent-chancellerie` (M5).
